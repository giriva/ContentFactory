...
This README is the merged entry point for the ContentFactory project. It combines the original product overview with the local setup instructions and the new agents-directory layout.
